...
**_Please DO NOT INSTALL THIS MODULE ON A CONTENT DELIVERY SERVER. It is intended for the Content Management server role only and the different API calls to delete items could be potentially harmful on an exposed Content Delivery server._**
